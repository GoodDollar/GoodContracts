...
contract ContributionCalculation is DSMath, SchemeGuard {
    ...
    event SellContributionRatioUpdated(address indexed caller, uint256 nom, uint256 denom);

    constructor(Avatar _avatar, uint256 _nom, uint256 _denom) public SchemeGuard(_avatar) {

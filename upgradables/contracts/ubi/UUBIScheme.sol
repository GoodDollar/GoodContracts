...
interface IIFirstClaimPool {
    function claimAmount() public returns(uint256);
    function awardUser(address user) public returns(uint256);
}
/* @title Dynamic amount-per-day UBI scheme allowing claim once a day
 */
contract UUBIScheme is UAbstractUBI {
    ...
    function initialize(
        ...
        UAbstractUBI.initialize(_avatar, _identity, 0);
    ...
    */
     ...
     * @return A bool indicating if UBI was claimed
     */
    function claim() public onlyWhitelisted returns (bool) {
